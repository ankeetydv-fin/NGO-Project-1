  ...
  return (
    <Section spacing="none" background="default">
      <div className="flex flex-col lg:flex-row w-full min-h-[500px]">
        ...
        {/* Content Half */}
        <div className="lg:w-1/2 bg-black text-white p-6 sm:p-8 md:p-12 lg:p-24 flex flex-col justify-center relative overflow-hidden border-l border-neutral-800">
          {/* Decorative Pattern */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#E53935]/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />
          
          <div className="relative z-10 max-w-xl">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold font-heading mb-6 leading-tight text-white">
              Become A Proud Volunteer Now
            </h2>
            <div className="w-16 h-1 bg-[#E53935] mb-8 rounded-full"></div>
